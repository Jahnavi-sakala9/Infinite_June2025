...
namespace CodeChallenge10
{
    ...
    public partial class northwindEntities1 : DbContext
    {
        ...
        [DbFunction("northwindEntities1", "get_customers_by_country")]
        public virtual IQueryable<get_customers_by_country_Result> get_customers_by_country(string country_name)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<get_customers_by_country_Result>("[northwindEntities1].[get_customers_by_country](@country_name)", country_nameParameter);
        }
